...
pub fn EncryptContentOpts(comptime P: type) type {
    return struct {
        ...
        /// Nonce.
        nonce: *const [P.nn]u8,
        /// Reuse guard per RFC 9420 Section 6.3.1.
        /// Caller MUST provide 4 CSPRNG-generated bytes.
        reuse_guard: *const [4]u8,
...
pub fn encryptContent(
    ...
    var guarded_nonce = nonce.*;
    applyReuseGuard(P, &guarded_nonce, reuse_guard);
    defer primitives.secureZero(&guarded_nonce);
